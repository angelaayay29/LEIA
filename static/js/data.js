...
const ORBIT_RETRO_META = {
  ...
  'ai-insight': {
    ...
    processing: [
      ...
      'Send that payload to the AI layer with a fixed prompt template (stored in ORBIT scripts/).',
  ...
  'headline-stats': {
    ...
    processing: [
      ...
      'Compare delivered points to the ORBIT day-1 snapshot for Planned vs Delivered.',
      'Average all EOW survey responses into the Team Health score.',
      'Count mid-sprint ticket adds and removals from Jira changelog for Scope Churn, then compute deltas vs the prior ORBIT snapshot.',
    ],
  },
  'program-progress': {
    ...
    processing: [
      ...
      'Compare this sprint\'s percentage to the prior ORBIT snapshot to produce the delta text (e.g. "+8% this sprint").',
  ...
  'work-detail': {
    ...
    processing: [
      ...
      'Pull retro-action labeled tickets from Jira and merge with any items still open from the prior ORBIT snapshot.',
    ],
  },
  'people-capacity': {
    ...
    processing: [
      ...
      'Plot the last five sprints\' average health scores from ORBIT history as a sparkline.',
    ],
  },
  'risks-followup': {
    ...
    processing: [
      ...
      'Compare each item to the prior ORBIT snapshot — if it existed last sprint and is still open, mark it Carried.',
      'Sort carried items to the top, then order remaining items by due sprint.',
    ],
  },
};

const ORBIT_PLANNING_META = {
  header: {
    ...ORBIT_RETRO_META.header,
  ...
  'ai-insight': {
    ...
    processing: [
      'Compare total committed points in Jira to the ORBIT rolling velocity average.',
  ...
  'program-progress': {
    ...ORBIT_RETRO_META['program-progress'],
    ...
    processing: [
      ...
      'Compare entering percentages to prior ORBIT snapshot to show whether each program is pacing toward its target.',
    ],
  },
  'work-detail': {
  ...
  'people-capacity': {
    ...
    processing: [
      ...
      'Compare each person\'s committed load to their 3-sprint ORBIT average and label as above, avg, or below.',
